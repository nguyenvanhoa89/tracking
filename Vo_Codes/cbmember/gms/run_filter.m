...
r_update(1)= 0.001;
w_update{1}(1)= 1;
m_update{1}(:,1)= [0.1;0;0.1;0];
P_update{1}(:,:,1)= diag([1000 100 1000 100]).^2;
L_update(1)= 1;
...
for k=1:meas.K
    ...
    for t=1:T_update
        ...
        [m_predict{t},P_predict{t}] = kalman_predict_multiple(model,m_update{t},P_update{t});                       %surviving components
