...
filter.H_sur= 100;                  %requested number of surviving components/hypotheses (for LMB to GLMB casting before update)
...
filter.hyp_threshold= 1e-10;        %pruning threshold for components/hypotheses (not used yet)
